...
6. Run 'python citra_services.py' / 'python3 citra_services.py' to run the code.
...
```
cd existing_repo
git remote add origin https://gitlab.com/yafiegustaff.2001/python_be.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/yafiegustaff.2001/python_be/-/settings/integrations)
